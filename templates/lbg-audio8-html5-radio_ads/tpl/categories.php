...
<div style="text-align:center; padding:0px 0px 20px 0px;"><img src="<?php echo plugins_url('images/icons/add_icon.gif', dirname(__FILE__))?>" alt="add" align="absmiddle" /> <a href="?page=LBG_AUDIO8_HTML5_SHOUTCAST_Add_New_Category">Add new (category)</a></div>
		...
		$row=lbg_audio8_html5_shoutcast_unstrip_array($row); ?>
					...
					<td><div id="editme<?php echo $row['id']?>"><?php echo $row['categ']?></div>
                        ...
                        jQuery("#editme<?php echo $row['id']?>").editInPlace({
								/*url: "?page=LBG_AUDIO8_HTML5_SHOUTCAST_Manage_Categories",
					...
					<td>
                        <a href="?page=LBG_AUDIO8_HTML5_SHOUTCAST_Manage_Categories&id=<?php echo $row['id']?>" onclick="return confirm('Are you sure?')" style="color:#F00;">Delete</a>
                        </td>					
	            </tr>
<?php } ?>                
						</tbody>
